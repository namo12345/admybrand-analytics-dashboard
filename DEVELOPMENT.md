...
```bash
git remote add encore encore://admybrand-analytics-dashboard-qzki
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/admybrand-analytics-dashboard-qzki/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/admybrand-analytics-dashboard-qzki/settings/integrations/github)
